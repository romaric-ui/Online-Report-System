...
const dbConfig = isProduction ? {
  ...
  host: process.env.PRIVATE_DB_HOST || process.env.DB_HOST,
  user: process.env.PRIVATE_DB_USER || process.env.DB_USER,
  password: process.env.PRIVATE_DB_PASSWORD || process.env.DB_PASSWORD,
