        ...
        <div className="md:flex">
          ...
          >
            <div className="mb-8">
              ...
              >
                Inscrivez votre entreprise et créez un compte administrateur
                pour gérer vos chantiers, rapports et équipes.
              </p>
            </div>
            <div className="space-y-4">
              ...
              >
                <p
                  ...
                  style={{ color: "rgba(255,255,255,0.8)" }}
                >
                  Suivez les étapes pour créer votre entreprise et son
                  administrateur.
                </p>
              </div>
            </div>
