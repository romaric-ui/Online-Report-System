    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(15,23,42,.45) 0%, rgba(15,23,42,.35) 60%, rgba(30,41,59,.25) 100%)",
          }}
        />
        {/* Yellow glow orb */}
        <div
          className="h-glow absolute top-1/3 right-1/4 w-96 h-96 rounded-full pointer-events-none"
          style={{
            background:
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            {/* Badge */}
            <div
              className="h-badge inline-flex items-center gap-2 px-4 py-1.5 rounded-full border mb-6"
              style={{
            ...
            >
              <span
                className="h-pulse w-2 h-2 rounded-full"
                style={{
                  background: "#F59E0B",
            ...
            <h1 className="h-title text-5xl lg:text-6xl xl:text-7xl font-black leading-[1.05] tracking-tight text-white mb-6">
              Pilotez vos
              <br />
              chantiers. <span style={{ color: "#F59E0B" }}>Sans</span>
              <br />
              compromis.
            </h1>
            ...
            {/* Subtitle */}
            <p
              className="h-sub text-lg leading-relaxed mb-8 max-w-lg"
              style={{ color: "#94a3b8" }}
            >
              La plateforme tout-en-un pour les pros du BTP. Suivi en temps
              réel, gestion d'équipes, budget, planning et sécurité — depuis le
              terrain.
            </p>
            ...
            {/* Stats */}
            <div
              className="h-stats flex flex-wrap gap-8 pt-8"
          ...
          <div className="hidden lg:block h-card">
            <div className="h-float">
              <div className="relative">
                    ...
                    >
                      <div>
                        ...
                        <div className="flex -space-x-2">
                          {["#3b82f6", "#22c55e", "#F59E0B", "#a855f7"].map(
                            (c, i) => (
                              <div
                                key={i}
                ...
                <div
                  className="absolute -bottom-5 -left-8 rounded-2xl border px-4 py-3 flex items-center gap-3 shadow-xl"
                  style={{
                    background: "#1E293B",
                    borderColor: "rgba(255,255,255,.1)",
                  }}
                ...
                <div
                  className="absolute -top-5 -right-6 rounded-2xl border px-4 py-3 flex items-center gap-3 shadow-xl"
                  style={{
                    background: "#1E293B",
                    borderColor: "rgba(255,255,255,.1)",
                  }}
