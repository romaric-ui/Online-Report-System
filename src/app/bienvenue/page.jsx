        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm text-slate-500 mb-4">
              Créez des rapports d'inspection BTP professionnels. 1 rapport
          ...
          >
            ...
            <p className="text-sm text-slate-500 mb-4">
              Plateforme complète pour gérer vos chantiers, équipes, budgets et
              rapports. Essai gratuit 7 jours.
            </p>
